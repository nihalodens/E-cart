...
const Header = ({insideHome}) => {
  ...
  return (
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
      ...
      { insideHome&& <li className='list-none inline-block px-5' ><input style={{width:'300px'}} className='rounded p-2 text-black' onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))}  type="text" placeholder='Search Products Here! ' /></li>}
