...
const Footer = () => {
  return (
    <footer className="bg-violet-600 text-white py-8 " style={{marginTop:"100px"}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="#instagram" className="text-white hover:text-gray-300"><i className="fab fa-instagram ms-8"></i></a>
              <a href="#facebook" className="text-white hover:text-gray-300"><i className="fab fa-facebook ms-8"></i></a>
              <a href="#linkedin" className="text-white hover:text-gray-300"><i className="fab fa-linkedin ms-8"></i></a>
              <a href="#github" className="text-white hover:text-gray-300"><i className="fab fa-github ms-8"></i></a>
              <a href="#phone" className="text-white hover:text-gray-300"><i className="fas fa-phone ms-8"></i></a>
            </div>
          </div>
        </div>
