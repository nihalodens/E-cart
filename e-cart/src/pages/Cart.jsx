          ...
          <table className="table-auto w-full">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product name</td>
                <td><img width={'70px'} height={'70px'} src="https://img.clevup.in/176694/bella-vita-luxury-goat-eau-de-parfum-perfume-for-m-1715928451758_SKU-1778_0.jpg?width=600&format=webp" alt="" /></td>
                <td>
                  <div className="flex">
